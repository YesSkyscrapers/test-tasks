          ...
          tab == 0 ? (
            ...
            <div className="Backend-task-container">
              ...
              <div className="Backend-task-text">
                ...
                <br />
                <br />
                <span>{`3)Такое же задание, что и в пункте 2, только вместо InMemory-хранилища использовать базу данных PostgreSQL (или MSSQL) и Entity Framework для работы с ней`}</span>
                <br />
                <br />
                <span>{`Любая реализация должна быть покрыта Unit-тестами, используя NUnit или XUnit. Также любая реализация должна быть выполнена на фреймворке ASP.NET Core 5.0 или выше. А еще `}</span><b>очень хочется</b><span>{` увидеть LINQ.`}</span>
              </div>
            </div>
          )
        }
